...
colors = ["Aqua", "Arc" "Blue", "Brown", "Faux-Royal-Red", "Green", "Grey", "Orange", "Pink", "Purple", "Red", "Sand", "Spring-Rain", "Teal", "Yellow"]
...
def usage():
    ...
    color can be: Aqua, Arc, Blue, Brown, Faux-Royal-Red, Green, Grey, Orange, Pink, Purple, Red, Sand, Spring-Rain, Teal, Yellow or All.")
    sys.exit(1)
